...
module.exports = async (client, msg) => {
  ...
  if (msg.guild === null) {
   if(await client.blacklist.get(msg.author.id) !== null) return msg.channel.send(`You are blacklisted from bBoxway support ${await client.blacklist.get(msg.author.id)}`)
